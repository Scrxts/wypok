...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/bootstrap/css/styles.css" type="text/css" rel="stylesheet">
</head>
...
<footer class="footer">
    <div class="container">
        <p class="navbar-text">Weekop - developed by Łukasz Tota & Mateusz Ochel</p>    </div>
</footer>
